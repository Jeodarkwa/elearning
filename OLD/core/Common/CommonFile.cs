...
namespace ElearningPlatform.Core
{
    public static class CommonFiles
    {
        ...
        //private byte[] key = {7, 4, 6, 6, 3, 3, 7, 4, 6, 8,
        //                     3, 7, 8, 6, 3, 6, 8, 7, 0, 0, 
        //                     6, 2, 8, 8};

        //public byte[] iv = { 19, 97, 2, 20, 08, 200, 200, 219 };

       // private byte[] _key = {7, 4, 6, 6, 3, 3, 7, 4, 6, 8,
		//					 3, 7, 8, 6, 3, 6, 8, 7, 0, 0, 
		//					 6, 2, 8, 8};

       // public byte[] _iv = { 19, 97, 2, 20, 08, 200, 200, 219 };
        ...
        private static byte[] EncryptText(string plainText)
        {
         ...
         //commented by Joe   ICryptoTransform cryptoTransform = tdesProvider.CreateEncryptor(this.key, this.iv); 
            ICryptoTransform cryptoTransform = tdesProvider.CreateEncryptor(); 
