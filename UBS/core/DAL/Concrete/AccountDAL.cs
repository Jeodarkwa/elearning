...
namespace ElearningPlatform.Core.DAL
{
    public class AccountDAL : IAccountDAL
    {
                ...
                try
                {
                    ...
                    using (SqlConnection stringConnection = new SqlConnection(ConnString.localConnection()))
                    {
                        using (SqlCommand sqlCom = new SqlCommand())
                        {
                            ...
                            sqlCom.CommandText = "[stPcd_UserCreate]";

                            sqlCom.Parameters.AddWithValue("@Name", Login);
                            sqlCom.Parameters.AddWithValue("@SirName", email);
                            sqlCom.Parameters.AddWithValue("@Email", password);


                            sqlCom.Parameters.AddWithValue("@Country", Login);
                            sqlCom.Parameters.AddWithValue("@Address", email);
                            sqlCom.Parameters.AddWithValue("@Telephone", password);


                            sqlCom.Parameters.AddWithValue("@Mobil", Login);
                            sqlCom.Parameters.AddWithValue("@BirthDate", email);
                            sqlCom.Parameters.AddWithValue("@MarriageStatus", password);

                            sqlCom.Parameters.AddWithValue("@Occupation", Login);
                            sqlCom.Parameters.AddWithValue("@Denomination", email);
                            sqlCom.Parameters.AddWithValue("@Role", password);
        ...
        public int CreateUserLogin(string Login, String password,  int userId)
        {
